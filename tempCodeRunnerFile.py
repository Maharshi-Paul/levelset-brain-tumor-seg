"""
================================================================================
Project: Mathematical Modeling of Brain Tumor Boundaries using Level Set PDEs
Institution: Jaypee Institute of Information Technology (JIIT)
Submitted to: Prof. Prashant Kumar Chauhan
Team:
 - Aditya Kumar Singh (Lead Coding & PDE Debugging)
 - Maharshi Paul [992501030287] (Mathematical UML, Flowcharts, & Report Making)
 - Krishna Gupta, Dipesh Choudhary, Atishay Jain (Simulation & Testing)

UPGRADE: "BEAST MODE" PARALLEL ENGINE & ASYNC GUI
================================================================================
"""
...
class BrainTumorMasterApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("JIIT Medical Image PDE Segmentation Dashboard")
